...
/**************************************************************************************************************** */
    ...
    //         data: null,
    //         render: function(data, type, row, meta) {
    //             // Verifica si el usuario tiene el rol adecuado para mostrar el botón
    //             if (hasRole('atencion') || hasRole('supadmin')) {
    //                 // Aquí defines el botón HTML con un id específico
    //                 return '<button id="btnAgregar_' + meta.row + '" class="btn btn-primary btn-sm">Agregar</button>';
    //             } else {
    //                 return ''; // Si no tiene el rol adecuado, no muestra ningún contenido en esa celda
    //             }
    //         }
    //     }
    // ];
        ...
        if (selectedRows.length > 0) {
            ...
            alert.fire({
                ...
                if (result.isConfirmed) {
                    // confirmation(plataforma, 'http://localhost:8000/partners' + id, '');
    ...
    const update = () => {
        ...
        if (selectedRows.length > 0) {
            ...
            //  sendRequest('PUT',formEdit.value,('http://localhost:8000/partners'+id),'');
    ...
    const save = () => 
        {     
            ...
            //  sendRequest('PUT',form.value,('http://localhost:8000/partners'+id),'');
