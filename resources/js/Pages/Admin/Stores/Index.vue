...
const deleteCliente = () => {
    ...
    if (selectedRows.length > 0) {
        ...
        // confirmation(plataforma, 'http://localhost:8000/stores' + id, '');
...
const update = () => {
    ...
    if (selectedRows.length > 0) {
        ...
        console.log(formEdit);
 //  sendRequest('PUT',formEdit.value,('http://localhost:8000/stores'+id),'');
...
const save = () => {
    ...
    console.log(form); 
            ...
            //  sendRequest('PUT',form.value,('http://localhost:8000/stores'+id),'');
