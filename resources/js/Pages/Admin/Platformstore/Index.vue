...
/**************************************************************************************************************** */
    ...
    const deleteCliente = () => {
        ...
        if (selectedRows.length > 0) {
            ...
            // confirmation(plataforma, 'http://localhost:8000/platformstore' + id, '');
...
formEdit.value.codigo_cliente=selectedRowsData.codigo_cliente
    ...
    const update = () => {
        ...
        if (selectedRows.length > 0) {
            ...
            //  sendRequest('PUT',formEdit.value,('http://localhost:8000/platformstore'+id),'');
    ...
    const save = () => 
        {     
            ...
            form.value.plataforma
                 //  sendRequest('PUT',form.value,('http://localhost:8000/platformstore'+id),'');
